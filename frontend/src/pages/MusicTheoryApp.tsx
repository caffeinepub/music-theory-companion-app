...
export default function MusicTheoryApp() {
  ...
  // activeKey: manual selection takes priority, then auto-detected (persists after stop)
  ...
  // NOTE: We intentionally do NOT reset autoDetectedKey when listening stops,
  // so the theory panel remains visible after the user stops the microphone.
